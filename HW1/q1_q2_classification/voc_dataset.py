        ...
        for index in self.index_list:
            ...
            for element in xml_root:
                if element.tag == "object":
                    class_idx = self.INV_CLASS[element.find('name').text]
                    class_vec[class_idx] = 1

                    # Check if the object is marked as difficult
                    difficulty = element.find('difficult').text
                    weight_vec[class_idx] = 0 if difficulty == "1" else 1
            ######################################################################
            #                            END OF YOUR CODE                        #
            ######################################################################
